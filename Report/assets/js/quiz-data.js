...
window.QUIZ_DATA = {
  ...
  "weeks": [
    ...
    },
    {
      ...
      "questions": [
        ...
        },
        {
          ...
          "explain": "Giles part 18 lập luận residual còn 'nhiều hơn' chỉ là shortcut gradient — nó cho phép mỗi block tinh chỉnh dần biểu diễn."
        },
        {
          "id": "w4q3",
          "type": "mcq",
    ...
    },
    {
      ...
      "questions": [
        ...
        },
        {
          ...
          "explain": "Giles part 32k đi sâu vào việc này khi train tốt hơn ở local."
        },
        {
          "id": "w5q3",
          "type": "mcq",
        ...
        },
        {
          "id": "w5q4",
          "type": "open",
          "q": "[Nâng cao] Giles thấy gì khi BỎ dropout trong pretraining, và vì sao?",
        ...
        },
        {
          "id": "w5q8",
          "type": "open",
          "q": "[Nâng cao] DistributedDataParallel (DDP) hoạt động thế nào (Giles part 29)?",
    ...
    {
      "week": 6,
      "title": "Instruction fine-tuning (Raschka ch.6–7 + LoRA)",
      "questions": [
        {
          "id": "w6q1",
          "type": "mcq",
        ...
        },
        {
          "id": "w6q2",
          "type": "mcq",
          "q": "Để fine-tune GPT cho classification (Raschka ch.6), thay đổi kiến trúc nào là cốt lõi?",
          "choices": [
        ...
        },
        {
          "id": "w6q3",
          "type": "open",
          "q": "Trong instruction fine-tuning (ch.7), vì sao thường mask phần prompt/instruction khỏi loss (chỉ tính loss trên phần response)?",
    ...
    },
    {
      ...
      "questions": [
        ...
        },
        {
          ...
          "explain": "Xem Raschka reasoning-from-scratch và nanochat chat_rl.py (tasks gsm8k, spellingbee)."
        },
        {
          "id": "w7q5",
          "type": "mcq",
          ...
          "answer": 1,
          "explain": "Midtrain là khái niệm KHÔNG có trong sách Raschka gốc; nó chuẩn bị base model cho giai đoạn chat/SFT."
        },
        {
          "id": "w7q6",
          "type": "open",
    ...
    },
    {
      ...
      "questions": [
        ...
        },
        {
          ...
          "explain": "BGE cross-encoder hoặc Cohere Rerank là lựa chọn phổ biến."
        },
        {
          "id": "w11q3",
          "type": "mcq",
        ...
        },
        {
          "id": "w11q5",
          "type": "open",
          "q": "Vì sao cần eval set + cẩn trọng với LLM-as-judge (Giles part 30)?",
          "answer": "Cần một eval set (cặp câu hỏi + ground-truth) để đo before/after một cách định lượng thay vì cảm tính. LLM-as-judge (dùng một LLM mạnh chấm output) tiện nhưng nhiều bẫy: thiên vị độ dài, thiên vị vị trí, tự khen model cùng họ. Giles còn cho thấy loss thấp hơn KHÔNG đảm bảo hữu ích hơn trong thực tế → đừng tin một chỉ số duy nhất; kết hợp metric tự động + kiểm tra thủ công.",
